...
public partial class MasterDataViewModel(IWarehouseService service) : ViewModelBase
{
    ...
    [RelayCommand] private void NewUnit() => SelectedUnit = new();
    ...
    [RelayCommand] private void NewSupplier() => SelectedSupplier = new() { ContractDate = DateTime.Today };
    ...
    [RelayCommand] private void NewCustomer() => SelectedCustomer = new() { ContractDate = DateTime.Today };
    ...
    [RelayCommand] private void NewProduct() => SelectedProduct = new();
